...
Source0  : https://files.pythonhosted.org/packages/6c/a7/98f9a4dfd7cb682eec1078eeb024b439f48e79d1aa0631ee1b20bfd1285a/types-six-1.16.17.tar.gz
...
%prep
%setup -q -n types-six-1.16.17
cd %{_builddir}/types-six-1.16.17
pushd ..
cp -a types-six-1.16.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657037277
