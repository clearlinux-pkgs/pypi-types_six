...
Source0  : https://files.pythonhosted.org/packages/b4/f1/53abd134a8838c6046b433cbe426aa51ccc70237cd196dfca735d7000984/types-six-1.16.21.20240311.tar.gz
...
%prep
%setup -q -n types-six-1.16.21.20240311
cd %{_builddir}/types-six-1.16.21.20240311
pushd ..
cp -a types-six-1.16.21.20240311 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710174419
