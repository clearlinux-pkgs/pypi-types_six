...
Source0  : https://files.pythonhosted.org/packages/9a/2c/dc04c3e25dec8b9af10052b6d71199a4d5f86e3ad0445bbaf9a51d873eb2/types-six-1.16.21.6.tar.gz
...
%prep
%setup -q -n types-six-1.16.21.6
cd %{_builddir}/types-six-1.16.21.6
pushd ..
cp -a types-six-1.16.21.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677083761
