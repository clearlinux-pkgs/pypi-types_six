...
Source0  : https://files.pythonhosted.org/packages/09/d6/fbea3d9fc8388abd98081c33ae4ca9ed5b11e947409ccbf85467df49bfe4/types-six-1.16.21.20241105.tar.gz
...
%prep
%setup -q -n types-six-1.16.21.20241105
cd %{_builddir}/types-six-1.16.21.20241105
pushd ..
cp -a types-six-1.16.21.20241105 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730823589
